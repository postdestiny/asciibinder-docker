...
RUN chown -R apache:root  /var/www/html /var/log/httpd /run/httpd
...
RUN cd /var/www/html
RUN git clone https://github.com/postdestiny/asciibinder-docs.git && cd asciibinder-docs # && git checkout  6827be
